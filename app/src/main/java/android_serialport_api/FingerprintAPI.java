...
public class FingerprintAPI {
	...
	/**
	 * Represents a template from a fingerprint database read
	 * error or invalid;
	 */
	 ...
	 * @return  Function Description: ImageBuffer the original image
