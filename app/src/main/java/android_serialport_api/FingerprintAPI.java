...
public class FingerprintAPI {
    ...
    /**
     * Input fingerprint_register_verify image indicates failure;
     */
    public static final int GET_IMAGE_FAIL = 0x03;
    /**
     * Represents the fingerprint_register_verify image is too dry, not too
     * light and health characteristics;
     */
    public static final int FINGERPRINT_SMALL = 0x04;
    /**
     * Represents the fingerprint_register_verify image is too wet, not too
     * paste feature is born;
     */
    public static final int FINGERPRINT_BLURRING = 0x05;
    /**
     * Indicates born fingerprint_register_verify image is too chaotic
     * fragmentation characteristics;
     */
    public static final int FINGERPRINT_NOT_GENCHAR = 0x06;
    /**
     * Represents the fingerprint_register_verify image is normal,
    ...
    /**
     * ； Indicates that the module can not accept subsequent
     * packets;
     */
    ...
    /**
     * set fingerprint_register_verify type: big or small
     *
     * @param type
     */
     ...
     * package is wrong Confirmation code=06H Indicates born fingerprint_register_verify
     * image is too chaotic fragmentation characteristics Confirmation
     * code=07H Represents the fingerprint_register_verify image is normal, but too few
     ...
     * 将图像缓冲区的数据上传给上位机
     *
     * @return Return value bmp format image of the fingerprint_register_verify, if null upload
     * failed
     */
